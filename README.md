...
Из недостатчков - разработчикам придётся заходить на сервер и смотреть journalctl -u your-app или tail -f /var/log/app/error.log.
...
Как исправить:
Считать только успешные запросы, например: только 200OK
Исключить 3xx, 1xx
